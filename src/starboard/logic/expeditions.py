...
def save_expedition(id,name1,name2,en_unit,difficulty,direction,date):
    with open(EXPEDITION_FILE,'ab') as file:
        ...
        file.write(struct.pack(EXPEDITION_FORMAT,id,name1,name2,en_unit,difficulty,direction,date))
